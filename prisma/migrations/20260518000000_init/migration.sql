...
-- CreateIndex
CREATE INDEX "Link_fromType_fromId_relation_idx" ON "Link"("fromType", "fromId", "relation");

-- CreateIndex
CREATE INDEX "Link_toType_toId_relation_idx" ON "Link"("toType", "toId", "relation");

-- CreateIndex
CREATE INDEX "Link_organizationId_idx" ON "Link"("organizationId");

-- CreateIndex
CREATE UNIQUE INDEX "Link_fromType_fromId_toType_toId_relation_key" ON "Link"("fromType", "fromId", "toType", "toId", "relation");
